...
async function makeAdminAndPopulate() {
  console.log('🚀 Starting to create admin and populate products...');
  ...
  try {
    ...
    try {
      ...
      console.log('User role:', loginResponse.data.object?.user?.role);
    ...
    console.log('   Email: superadmin@skillbridge.com');
